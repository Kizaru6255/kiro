...
class _AddMoneyScreenState extends ConsumerState<AddMoneyScreen> {
  ...
  Future<void> _handleAddMoney() async {
    ...
    await ref.read(walletNotifierProvider.notifier).addMoney(amount: amount);

    final walletAsync = ref.read(walletNotifierProvider);
    walletAsync.whenData((_) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 32),
                FilledButton(
                  onPressed: walletAsync.isLoading ? null : _handleAddMoney,
