...
class _$PaymentImpl implements _Payment {
  ...
  @override
  String toString() {
    return 'Payment(id: $id, orderId: $orderId, amount: $amount, currency: $currency, method: $method, status: $status, transactionId: $transactionId, gateway: $gateway, description: $description, completedAt: $completedAt, createdAt: $createdAt, metadata: $metadata)';
  }
...
abstract class _Payment implements Payment {
  const factory _Payment(
      ...
      final Map<String, dynamic>? metadata}) = _$PaymentImpl;
