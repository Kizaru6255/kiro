...
class _$TransactionDtoImpl implements _TransactionDto {
  ...
  @override
  String toString() {
    return 'TransactionDto(id: $id, walletId: $walletId, type: $type, status: $status, amount: $amount, currency: $currency, description: $description, referenceId: $referenceId, recipientId: $recipientId, senderId: $senderId, completedAt: $completedAt, createdAt: $createdAt, metadata: $metadata)';
  }
...
abstract class _TransactionDto implements TransactionDto {
  const factory _TransactionDto(
      ...
      final Map<String, dynamic>? metadata}) = _$TransactionDtoImpl;
